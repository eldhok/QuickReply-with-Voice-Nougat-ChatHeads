 ...
 */
class DecisionMaker {
    public static final String ACTION_ADD = "com.notifications.screen.action.ADD";
    public static final String ACTION_REMOVE = "com.notifications.screen.action.REMOVE";

    public static final String EXTRA_NOTIFICATION = "com.notifications.screen.extra.NOTIFICATION";
    public static final String EXTRA_PACKAGE_NAME = "com.notifications.screen.extra.PACKAGE_NAME";
    public static final String EXTRA_TAG = "com.notifications.screen.extra.TAG";
    public static final String EXTRA_ID = "com.notifications.screen.extra.ID";
    public static final String EXTRA_SRC = "com.notifications.screen.extra.SRC";

    public static final String logTag = "DecisionMaker";

    //addition
    public void handleActionAdd(Integer action_size,Notification notification, String packageName, String tag, int id, String key, Context context, String src) {
        ...
        Log.d("Lines", "reached inside Decision maker");
        ...
        // intent.putExtra("reply_action_count", notification.extras.getInt("reply_action_count"));
        intent.putExtra("reply_action_count", action_size);

        Log.d("Lines", "reached inside Decision maker Value 1 : "+notification.extras.getInt("reply_action_coun"));
        Log.d("Lines", "reached inside Decision maker Value 2 : "+notification.extras.getInt("android.reply_action_coun"));
        Log.d("Lines", "reached inside Decision maker Value 3 : "+action_size);
        ...
        if (preferences != null && preferences.getBoolean("broadcast_notifications", false)) {
            ...
            context.sendBroadcast(broadcastIntent, "com.notifications.permission.NOTIFICATIONS");
        }
