 ...
 */
public class bubble_only extends ThemeClass {

    public bubble_only(ViewStub stub) {
        super(stub);
        stub.setLayoutResource(R.layout.bubble_only);
    }
...
*/
        ...
        //button.setBackgroundResource(R.drawable.buttonbackground);
       button.setBackgroundResource(R.drawable.shape_chat_mine_green);

       button.setPadding(5,0,5,0);


        if (OverlayServiceCommon.preferences.getBoolean("pro_color_change", false))
            ((GradientDrawable)button.getBackground()).setColor(OverlayServiceCommon.preferences.getInt("pro_color",Color.BLACK));
